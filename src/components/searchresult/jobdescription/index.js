            ...
            <div className={styles.descriptionContent}>
              ...
              <div>
                ...
                <ol>
                  ...
                  <li>
                    Tổ chức phỏng vấn, tuyển dụng, định hướng nghề nghiệp cho
                    ứng viên
                  </li>
                  <li>
                  ...
                  <li>
                    Tổ chức xuất cảnh Tổ chức lễ đón thực tập sinh về nước
                  </li>
                </ol>
              </div>
              ...
              <div>
                <ol>
                  ...
                  <li>
                    Thành thạo vi tính văn phòng, kỹ năng đánh máy 10 ngón (từ
                    35 wpm)
                  </li>
                  <li>
                    Vui vẻ, nhiệt tình, có tinh thần học hỏi, yêu thích công
                ...
                <div>
                  ...
                  <p>
                    Trụ sở chính: 40/12 - 40/16 Ấp Bắc, Phường 13, Quận Tân
                    Bình, TP Hồ Chí Minh
                  </p>
                  <ul>
                    <li>
                      Văn phòng tại Nhật Bản: 101-0047 Arte Otemachi, 5F,
                      1-5-16, Uchikanda, Chiyoda-ku, Tokyo, Japan
                    </li>
                    <li>Chi nhánh: Đà Nẵng</li>
                    <li>
                      Trung tâm liên kết: Hồ Chí Minh, Vũng Tàu, Bình Dương,
                      Đồng Nai, Vĩnh Long, Tiền Giang, Bến Tre, Trà Vinh, Huế ,
                      Hà Nội
                    </li>
                  </ul>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>
                      Nghỉ chiều thứ 7, chủ nhật và các ngày nghỉ lễ theo quy
                      định trong năm.
                    </li>
                  </ul>
                  <p>
                  ...
                  <ul>
                    ...
                    <li>
                      Thưởng hiệu quả công việc: 2 kỳ / năm &amp; các kỳ thưởng
                      lễ (30/04, 02/09, 20/11, 01/01)
                    </li>
                    <li>Tham gia các sự kiện: du lịch, teambuilding, …</li>
                    <li>
                      Phúc lợi Sinh nhật, Đám cưới, Sinh con, Thăm bệnh, Khám
                      sức khỏe định kỳ hằng năm, Tham gia BHXH-BHYT, Chế độ Bảo
                      hiểm cao cấp đối với nhân viên thâm niên,…
                    </li>
                    <li>
                      Trợ cấp nhà xa, Cơm trưa, Môi trường làm việc, Thai sản,..
                    </li>
                    <li>
                      Phụ cấp ngoài giờ, Phụ cấp di chuyển chi nhánh, Phụ cấp
                      công tác.
                    </li>
                  </ul>
                  <p>
