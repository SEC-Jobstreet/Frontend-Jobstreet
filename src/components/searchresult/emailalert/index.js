...
import CreateJobAlertModel from "../../jobalerts/components/CreateJobAlertModel";
...
function EmailAlert() {
  ...
  const onHideModelHandler = () => {
    setShowModel(false);
  };
  return (
    <>
      {showModel && (
        <CreateJobAlertModel onHideModelHandler={onHideModelHandler} />
      )}
      <Card className={styles.wrapper}>
        <Card.Body className={styles.card}>
          ...
          <Button className={styles.notiButton} onClick={onShowModelHandler}>
